...
if __name__ == '__main__':
    input = torch.randn(64, 3, 64, 64)
    x1 = CondConv(in_planes=3, out_planes=64, kernel_size=3, stride=1, padding=1, bias=False)
    x2 = CondConv(in_planes=3, out_planes=512, kernel_size=3, stride=1, padding=1, bias=False)
    x3 = CondConv(in_planes=3, out_planes=1024, kernel_size=3, stride=1, padding=1, bias=False)
